...
## Learning Objectives
- Understand how to replicate a Palindrome checker application which is a simple app that checks different words to either confirm they are palindrome or not. it  supports a good user interface and interesting user experience.

## Description of the Project
For the first milestone in the process of creating Palindrome checker, you will:
...
## Acknowledgements
- Special thanks goes to Tech with Tim for the provision of background knowledge.
